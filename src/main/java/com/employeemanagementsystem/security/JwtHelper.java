...
public class JwtHelper {
    ...
    //The above method can be written in simple terms as below
//    public String getUsernameFromToken(String token) {
//        // Call the getClaimFromToken method and pass it the token and a lambda expression to get the subject
